                            ...
                            <form class="space-y-4" @submit.prevent="submit">
                                <div>
                                    <label for="name"
                                        ...
                                        la Categoria</label>
                                    <input v-model="form.name" type="string" name="name" id="name"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        placeholder="relojes,billeteras..." required />
                                </div>


                                <button @click="submit" type="submit"
                                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear</button>
        ...
        <tbody>
            <tr v-for="category in categories" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 text-right">
                    <button @click="selectCategory(category.id, category.name)" data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                ...
                <td class="px-6 py-4 text-right">
                    <button class="font-medium text-red-600 dark:text-red-500 hover:underline" @click="deleteCategory(category.id)">Eliminar</button>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" @submit.prevent="updateCategory">
                                ...
                                <button @click="updateCategory" type="submit"
